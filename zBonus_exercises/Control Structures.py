...
#the one that works
alien_color = "yellow" #variable with alien color

if alien_color == "yellow": #if the variable is equal to yellow
    print ("Player one earned 5 points!") #it prints this


#the one that fails

alien_color = "red" #variable with alien color
